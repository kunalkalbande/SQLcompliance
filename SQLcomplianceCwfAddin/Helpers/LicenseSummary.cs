...
namespace SQLcomplianceCwfAddin.Helpers
{
    ...
    {
        private static readonly TracerX.Logger Log = TracerX.Logger.GetLogger("LicenseSummary");
        ...
        public List<CheckedKey> CheckedKeys = new List<CheckedKey>();
                        ...
                        else
                        {
                            ...
                            if (prevIndex == curIndex)
                            {
                                ...
                                if (licErr == LicErr.OK)
                                {
                                    ...
                                    else if (lic.ProductID != CoreConstants.ProductID)
                                    {
                                    ...
                                    else if (!lic.IsTrial && lic.ProductVersion.Major < 5)
                                    {
                                        checkedKey.Comment = "The license key is for an older version of SQL diagnostic manager.  Please visit the customer portal to acquire a new license key at " + CoreConstants.CustomerPortalLink + ".";
                                    }
                            ...
                            if (checkedKey.IsValid)
                            {
                                ...
                                else if (summary.LicensedServers != BBSLic.Unlimited)
                                {
                                    ...
                                    if ((lic.IsTrial && !lic.IsExpired) || (lic.ProductVersion.Major >= 5))
        ...
        private class LicenseSummaryRenderer : IObjectRenderer
        {
