...
{
   public class BeforeAfterEvent : ColumnLevelEvent
   {
      ...
      public override void Load(SqlDataReader reader)
      {
         ...
         beforeValue = SQLHelpers.GetString(reader, column++);
         afterValue = SQLHelpers.GetString(reader, column++);
