...
namespace Idera.SQLcompliance.Core.Licensing
{
   ...
   public class BBSProductLicense
   {
      ...
      public static readonly Version SUPPORTED_PREVIOUS_LICENSE_VERSION = new Version(5, 0);
      ...
      public void RemoveLicense(int id)
      {
         ...
         {
            ErrorLog.Instance.Write("Error Removing License: ", ex.Message);
         }
      ...
      public void AddLicense(string licenseString)
      {
         ...
         if (IsLicenseStringValid(licenseString, out licState))
         {
            ...
            {
               ErrorLog.Instance.Write("Error Adding License: ", ex.Message);
            }
         }
      }
      ...
      //---------------------------------------------------------------------
      // This change has been made with reference to SQLCM-4858 while upgrading from v5 to v6
      // Change summary 
      // Changed DaysToExpiration from 32767 to IsPermanent
      // Used constant BBSLic. Unlimited for Unlimited license instead of hard coded -1
      // Updated Limited license condition
      ...
      public void TagTrialLicenseUsed()
      {
         ...
         try
         {
            ...
            string key = CoreConstants.RegistryHiveLicensing ;
         ...
         {
            ErrorLog.Instance.Write("Error Tagging Trial license in Registry: ", ex.Message);
         }
         finally
         {
      ...
      // Write to special registry location that trial has been used on this server
      public void TagLicenseConversionUsed()
      {
         RegistryKey hklm;
         RegistryKey hkSoftware = null;
         RegistryKey hkMicrosoft = null;
         RegistryKey hkLicensing = null;
         RegistryKey hkFinal = null ;
         ...
         try
         {
            ...
            {
               hkLicensing = hkMicrosoft.CreateSubKey(key);
               hkFinal = hkLicensing.CreateSubKey(CoreConstants.RegistryHiveLicensingConversion.ToString()) ;
            }
         }
         catch (Exception ex)
         {
            ErrorLog.Instance.Write("Error Tagging Conversion in Registry: ", ex.Message);
         }
         finally
         {
            if (hkSoftware != null) hkSoftware.Close();
      ...
      // Check special registry location to see if an old license conversion has already occurred
      public bool HasLicenseConversionBeenDone()
      {
         bool bUsed = true;
         RegistryKey hklm;
         RegistryKey hkSoftware = null;
         ...
         try
         {
            ...
            {
               hkFinal = hkLicensing.OpenSubKey(CoreConstants.RegistryHiveLicensingConversion.ToString(), false) ;
               if(hkFinal == null)
                  bUsed = false ;
               else
                  bUsed = true ;
      ...
      private void LoadLicenses()
      {
         ...
         {
            m_loaded = false;
            ErrorLog.Instance.Write("Error Loading License: ", ex, true);
         }
      }
