namespace Idera.SQLcompliance.Application.GUI.Controls
{
   partial class ActivityLogView
   {
      ...
      private void InitializeComponent()
      {
         ...
         Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Date");
         Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn2 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Time");
         Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn3 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Details");
         Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn4 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("SQLServer");
         Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn5 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Event");
         ...
         Infragistics.Win.UltraWinGrid.UltraGridBand ultraGridBand1 = new Infragistics.Win.UltraWinGrid.UltraGridBand("ActivityLog", -1);
         Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Date");
         Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Time");
         Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn3 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Details");
         Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn4 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("SQLServer");
         Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn5 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Event");
         ...
         Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool4 = new Infragistics.Win.UltraWinToolbars.ButtonTool("collapseAll");
         Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool5 = new Infragistics.Win.UltraWinToolbars.ButtonTool("expandAll");
         ...
         this._dataSource.Band.Columns.AddRange(new object[] {
            ...
            ultraDataColumn5,
            ultraDataColumn6});
         this._dataSource.Band.Key = "ActivityLog";
         // 
         // _lblStatus
         // 
         ...
         this._lblStatus.Location = new System.Drawing.Point(3, 151);
         ...
         this._grid.DataMember = "ActivityLog";
         ...
         ultraGridColumn4.Header.Caption = "SQL Server";
         ultraGridColumn4.Header.VisiblePosition = 3;
         ultraGridColumn4.Width = 154;
         ultraGridColumn5.Header.VisiblePosition = 4;
         ultraGridColumn5.Width = 278;
         ultraGridColumn6.Header.Caption = "";
         ultraGridColumn6.Header.VisiblePosition = 0;
         ultraGridColumn6.MaxWidth = 20;
         ...
         this._lblNavigation.Location = new System.Drawing.Point(3, 3);
         ...
         appearance7.Image = global::Idera.SQLcompliance.Application.GUI.Properties.Resources.CollapseAll_161;
         buttonTool1.SharedProps.AppearancesSmall.Appearance = appearance7;
         buttonTool1.SharedProps.Caption = "Collapse All";
         appearance8.Image = global::Idera.SQLcompliance.Application.GUI.Properties.Resources.ExpandAll_161;
         buttonTool2.SharedProps.AppearancesSmall.Appearance = appearance8;
         buttonTool2.SharedProps.Caption = "Expand All";
         appearance9.Image = global::Idera.SQLcompliance.Application.GUI.Properties.Resources.Refresh_16;
         ...
         stateButtonTool1.ToolbarDisplayStyle = Infragistics.Win.UltraWinToolbars.StateButtonToolbarDisplayStyle.Glyph;
         ...
         stateButtonTool2.SharedProps.Caption = "Show Group By";
         stateButtonTool2.ToolbarDisplayStyle = Infragistics.Win.UltraWinToolbars.StateButtonToolbarDisplayStyle.Glyph;
         ...
         this.HelpRequested += new System.Windows.Forms.HelpEventHandler(this.ActivityLogView_HelpRequested);
