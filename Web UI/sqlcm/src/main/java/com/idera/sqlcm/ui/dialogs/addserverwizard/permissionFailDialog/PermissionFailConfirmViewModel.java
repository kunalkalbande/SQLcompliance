package com.idera.sqlcm.ui.dialogs.addserverwizard.permissionFailDialog;
...
public class PermissionFailConfirmViewModel {
    ...
    private static final String ZUL_URL = "~./sqlcm/dialogs/addserverwizard/permission-fail-confirm-dialog.zul";
    ...
    public static class CMPermissionDecorator implements IFailedPermissionItemDecorator {
        ...
        private static final String NAME_STYLE = " color: #363636; font-weight: bold; ";
        private static final String RESOLUTION_STEPS_STYLE = " color: #363636; ";
