package com.idera.sqlcm.ui.dialogs.eventFilterWizard.permissionFailDialog;
...
public class PermissionFailConfirmViewModel {
    ...
    private static final String ZUL_URL = "~./sqlcm/dialogs/eventFilterWizard/permission-fail-confirm-dialog.zul";
