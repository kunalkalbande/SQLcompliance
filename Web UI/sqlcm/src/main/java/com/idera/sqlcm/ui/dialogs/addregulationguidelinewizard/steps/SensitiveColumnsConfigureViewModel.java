...
public class SensitiveColumnsConfigureViewModel {
	...
	public static final String ZUL_URL = "~./sqlcm/dialogs/regulationguidelinewizard/sensitive-columns-configure-dialog.zul";
	...
	public static final String DATABASE_ADDED = "database-added";
	...
	private HashMap<Long, CMTable> sensitiveColumnDataChangeMap = new HashMap<Long, CMTable>();
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view,
		...
		if (databaseProperties.getSensitiveColumnTableData().getStatusMessage() != null) {
			...
			} else if (databaseProperties.getSensitiveColumnTableData()
					.getSensitiveTableColumnDictionary() != null) {
				sensitiveColumnsTablesListModelList.addAll(databaseProperties
						.getSensitiveColumnTableData()
						.getSensitiveTableColumnDictionary());
			}
