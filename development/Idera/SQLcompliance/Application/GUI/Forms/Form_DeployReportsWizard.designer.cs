...
{
   partial class Form_DeployReportsWizard
	{
      /// <summary>
      ...
      private void InitializeComponent()
      {
         ...
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_DeployReportsWizard));
         ...
         label9.TabIndex = 0;
         label9.Text = "Specify which SQL Server instance hosts the SQL Compliance Manager Repository:";
         // 
         // label2
         // 
         ...
         this._lblIntro.Text = "This wizard allows you to integrate SQL Compliance Manager Reports with your exis" +
             "ting Microsoft Reporting Services installation.";
         // 
         // _pnlSummary
         // 
         ...
         this._linkFinalLocation.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.LinkClicked_linkFinalLocation);
         // 
         ...
         this._lblFinalStatusMessage.Size = new System.Drawing.Size(340, 13);
         this._lblFinalStatusMessage.TabIndex = 1;
         this._lblFinalStatusMessage.Text = "You have successfully deployed the SQL Compliance Manager reports.";
         ...
         this.Name = "Form_DeployReportsWizard";
         this.ShowInTaskbar = false;
         this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
         this.Text = "Deploy Reports";
