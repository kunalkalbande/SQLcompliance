...
{
   partial class Form_AgentMajorUpgrade
	{
      /// <summary>
      ...
      {
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_AgentMajorUpgrade));
         ...
         this.label8.Text = "Ready to upgrade the SQLcompliance Agent";
         // 
         // label9
         // 
         ...
         // textSummaryAccount
         // 
         this.textSummaryAccount.Location = new System.Drawing.Point(120, 60);
         ...
         // textSummaryComputer
         // 
         this.textSummaryComputer.Location = new System.Drawing.Point(120, 36);
         ...
         // lblInstance
         // 
         this.lblInstance.Location = new System.Drawing.Point(28, 40);
         ...
         this.label11.Text = "You are ready to upgrade the SQLcompliance Agent on the listed computer:";
         // 
         // label10
         // 
         ...
         this.label10.Text = "Click Finish to begin the upgrade process. This may take several minutes as it up" +
             "grades the SQLcompliance Agent on the remote computer.";
         // 
         ...
         this.Name = "Form_AgentMajorUpgrade";
         this.ShowInTaskbar = false;
         this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
         this.Text = "Upgrade SQLcompliance Agent";
         this.HelpRequested += new System.Windows.Forms.HelpEventHandler(this.Form_AgentMajorUpgrade_HelpRequested);
