...
{
   partial class Form_GroomingProgress
	{
      /// <summary>
      ...
      private void InitializeComponent()
      {
         ...
         this.tbMessage.Text = "Grooming audit data for ";
         // 
         // Form_GroomingProgress
         // 
         ...
         this.Name = "Form_GroomingProgress";
         this.ShowInTaskbar = false;
         this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
         this.Text = "Grooming in progress...";
