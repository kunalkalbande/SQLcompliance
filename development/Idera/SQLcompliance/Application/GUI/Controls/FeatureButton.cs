...
namespace Idera.SQLcompliance.Application.GUI.Controls
{
    ...
    public partial class FeatureButton : UserControl
    {
        ...
        private void DrawMouseOver(Graphics graphics)
        {
            if (graphics != null)
            {
                using (Pen pen = new Pen(Color.FromArgb(255, 231, 162)))
                {
                    Rectangle bounds = Rectangle.Inflate(ClientRectangle, -1, -1);
                    DrawRoundRectangle(graphics, pen, Color.FromArgb(255, 255, 255), Color.FromArgb(255, 231, 162),
                                       bounds, 5);
                }
            }
        }
        ...
        private void DrawClicked(Graphics graphics)
        {
            if (graphics != null)
            {
                ...
                {
                    Rectangle bounds = Rectangle.Inflate(ClientRectangle, -1, -1);
                    DrawRoundRectangle(graphics, pen, Color.FromArgb(255, 231, 162), Color.FromArgb(242, 149, 54),
                                       bounds, 5);
                }
            }
        }
