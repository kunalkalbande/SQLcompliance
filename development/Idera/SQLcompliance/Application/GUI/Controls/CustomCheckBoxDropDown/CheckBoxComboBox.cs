    ...
    public partial class CheckBoxComboBox : PopupComboBox
    {
        ...
        public CheckBoxComboBoxItemList CheckBoxItems
        {
            get
            {
                ...
                if(_CheckBoxComboBoxListControl.Items[_CheckBoxComboBoxListControl.Items.Count - 1].Text != Items[Items.Count - 1].ToString())
                    _CheckBoxComboBoxListControl.SynchroniseControlsWithComboBoxItems();
        ...
        {
            CheckBoxComboBoxItem comboBox = (CheckBoxComboBoxItem)sender;
            if (comboBox.Text == "<ALL>")
            {
                if (comboBox.CheckState == CheckState.Checked)
                {
                    for (int Index = 1; Index <= _CheckBoxComboBoxListControl.Items.Count - 1; Index++)
                    {
                        CheckBoxComboBoxItem Item = _CheckBoxComboBoxListControl.Items[Index];
                        Item.Checked = true;
                    }
            ...
            {
                if (comboBox.Text != "<ALL>" && comboBox.CheckState == CheckState.Unchecked)
                {
                    CheckBoxComboBoxItem Item = _CheckBoxComboBoxListControl.Items[1];
            ...
            {
                if (ListText.Contains("<ALL>"))
                {
                    Items[0] = "<ALL> ";
                    CheckBoxItems[0].ComboBoxItem = "<ALL> ";
                }
                else
                {
                    Items[0] = ListText;
        ...
        public void SynchroniseControlsWithComboBoxItems()
        {
            ...
            if (_CheckBoxComboBox._MustAddHiddenItem)
            {
                _CheckBoxComboBox.Items.Insert(
                    0, _CheckBoxComboBox.GetCSVText(true)); // INVISIBLE ITEM
            ...
            if (NewList.Count == 2
                && (NewList[0].Text  == "" || NewList[0].Text == "<ALL>")
                && NewList[1].Text == "<ALL>")
            {
                NewList[1].CheckState = CheckState.Checked;
            }
