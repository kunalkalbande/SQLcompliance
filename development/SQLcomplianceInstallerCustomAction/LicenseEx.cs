        ...
        public void RemoveLicense(int id)
        {
            try
            {
                ...
                using (var connection = new OleDbConnection(m_connectionString))
                {
                    ...
                    var paramLicenseId = new OleDbParameter(ParamLicenseId, id);
            ...
            if (IsLicenseStringValid(licenseString, out licState))
            {
                try
                {
                    ...
                    using (var connection = new OleDbConnection(m_connectionString))
                    {
                        ...
                        // Setup remove job params.
                        var paramLicenseKey = new OleDbParameter(ParamLicenseKey, licenseString);
        ...
        private void LoadLicenses()
        {
            ...
            try
            {
                using (var connection = new OleDbConnection(m_connectionString))
                {
                    ...
                    //Get Schedule
                    var cmd = new OleDbCommand(ViewLicenses, connection);
