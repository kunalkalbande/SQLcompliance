...
{
   public class ChangeLogViewFilter
   {
      #region Properties
      ...
      public ChangeLogViewFilter Clone()
      {
         ChangeLogViewFilter retVal = (ChangeLogViewFilter)MemberwiseClone();
