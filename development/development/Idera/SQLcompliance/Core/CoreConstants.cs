...
namespace Idera.SQLcompliance.Core
{
    ...
    public class CoreConstants
    {
        ...
        public const string AgentMinorUpgradeColletion = " COLLECT_SERVER=\"{0}\" ";
        ...
        // Registry Settings
        public const string Agent_RegKey = @"Software\Idera\SQLCM\SQLcomplianceAgent";
        ...
        public const string Agent_RegVal_IsCompressedFile = "IsCompressedFile";
        ...
        public const string Agent_AuditLogSPName = "sp_SQLcompliance_AuditLog";
        ...
        public const string Agent_Full_AuditLogSPName = "master.dbo." + Agent_AuditLogSPName;
        ...
        public const int StreamBufferSize = 32768;
        ...
        // Agent app config setting
        public const string Agent_EnableRowcount_configName = "SQLcomplianceAgent.EnableRowCountForDatabaseAuditing";
        ...
        public const string AlertsServiceName = "SQLcomplianceAlertsService";
        public const string AlertsServiceDisplayName = "SQLcompliance Alerts Service";
        ...
        public static Hashtable InstanceLocks = new Hashtable();
        public static readonly object AcquireInstanceLock = new object();

        //public const string   CollectionService_TraceDirectory  = "RepositoryTraceFiles";

        // Registry Settings
        public const string SQLcompliance_RegKey = @"Software\Idera\SQLCM";
        public const string SQLcompliance_RegKey_Path = "Path";
        public const string SQLcompliance_RegKey_Version = "Version";

        public const string CollectionService_RegKey = @"Software\Idera\SQLCM\CollectionService";
        ...
        public const string RegistryPath = "SOFTWARE\\Idera\\SQLCM\\SQLcomplianceAgent";
        public const string RegistryKey = "IsInstalledManually";
        #endregion
        ...
        public const string LmProductVersion = "5.8";
        ...
        public const string Exception_InvalidTraceDateFormat = "The trace file name date format is Invalid : {0}";
        ...
        public const string Exception_ServiceAccountNotSysadmin =
           ...
           "The service account must be a a member of Systems Administrators or has sufficient privileges for the user.\n\n";
        ...
        public const string Exception_ErrorProcessingXELFile = "An error occurred processing the XEvent file: {0}. ";
        ...
        public const string Exception_InstanceDatabaseTable = "An error occurred while updating the Databases table.\n\nError:\n\n{0}";

        //Audit Logs
        public const string Exception_ErrorProcessingAuditLogFile = "An error occurred processing the Audit Log file: {0}. This will be automatically retried later.";
        public const string Exception_CantLoadAuditLogFile = "An error occurred loading the events in Audit Log file from '{0}'. SQL Compliance Manager will automatically retry later.";
        ...
        public const string Exception_InvalidInstance = "This alert rule contains incomplete criteria.  Please specify properly the instance criteria or remove it before to continue with the alert configuration.";
        ...
        //Audit Logs
        internal const string Exception_CantReadAuditLogFile =
          "The Collection Server is unable to read the Audit Log file to process its events. This is usually a result of the SQL Server service account having insufficient privileges to read the files in the Collection Server trace directory. Audit Log file: {0}";
        public const string Error_AuditLogsAgentNotReachable = "SQL Server Audit Specifications could not be switched on because the agent is not reachable. Please check the agent status and try again.";
        public const string Error_AuditLogsAgentVersionNotCompatible = "SQL Server Audit Specifications functionality is supported for 5.5 and later version of SQL Compliance Manager Agent.";
        public const string Error_AuditLogsSQLServerNotSupported = "SQL Server Audit Specifications functionality is supported for SQL Server 2017 and above.";
        public const string Error_AuditLogsGenericErrorMessage = "SQL Server Audit Specifications can not be turned on at this time. Please try again after some time. If problem persists, contact IDERA support.";


        //Extended Event Error Messages  
        public const string Error_XEventAgentNotReachable = "Extended events could not be switched on because the agent is not reachable. Please check the agent status and try again.";
        public const string Error_XEventAgentVersionNotCompatible = "Extended events functionality is supported for 5.4 and later version of SQL Compliance Manager Agent.";
        public const string Error_XEventSQLServerNotSupported = "Extended events functionality is supported for SQL Server 2012 and above.";
        public const string Error_XEventGenericErrorMessage = "Extended Events can not be turned on at this time. Please try again after some time. If problem persists, contact IDERA support.";
        ...
        internal const int SerializationVersion_55 = 550;
        internal const int SerializationVersion_56 = 560;
        internal const int SerializationVersion_57 = 570;
        internal const int SerializationVersion_58 = 580;
        internal const int SerializationVersion_59 = 590;  // Serialization Version change for each release
        internal const int SerializationVersion = SerializationVersion_59;       // Serialization Version change for each release
        ...
        /// <summary>
        /// Reading DateTime using ParseExact
        /// </summary>
        public const string DateTimeParseFormat = "yyyyMMddHHmmss";
        ...
        public const string Info_EventDatabaseLimitExceeded =
          "Event Database Limit Exceeded: \r\n\r\n" +
          "Your event database limit has been exceeded. " +
          "Please archive your event database to cleanup the space.\r\n" +
          "It is recommended to archive the event database on regular intervals to avoid such issues.";
        ...
        //-------------------------------------------------------------------------
        public const int RepositorySqlComplianceDbSchemaVersion = 2402;
        public const int RepositoryEventsDbSchemaVersion = 1303;
        ...
        public const string RepositoryReportCardTable = "ReportCard";
        ...
        //5.7 Requirement 5.3.4.2
        public const string RepositoryUsersTable = "Users";
        ...
        public const string SensitiveColumnIndividualTableType = "Individual";
        public const string RepositoryReportAccessTable = "ReportAccess";
        public const string RepositoryAuditReportsTable = "AuditReports";
        ...
        public const string RepositoryLoginsTablesColumn = "name,id";
        ...
        public const string InstanceDatabasesTable = "Databases";
        #endregion
        ...
        public const string BlankStoredProcedure =
  @"
ALTER PROC {0}
AS
BEGIN
...
";
        ...
        public const string RepositoryInfo_SqlCm5_6 = "SQLCM-5.6";
        ...
        public const string PermissionCheck2 = @"Collection Service has rights to read registry HKLM\Software\Idera\SQLCM.";
        ...
        public const string PermissionCheck5 = @"Agent Service has rights to read registry HKLM\Software\Idera\SQLCM.";
        ...
        public const string IndividualColumnType = "Individual";
        public const string DatasetColumnType = "Dataset";
        #endregion
        ...
        public const string DbUpdateErrorMsg = "An error occurred trying to save the changes to the database. The database may be modified after the problem is resolved. ";
        public const string RepositoryInfoErrorMsg = "An error occurred trying to update the repository information for SQLCM 5.6. ";

        //start sqlcm 5.6 - 5467
        public const string IderaDefaultServerPropertise = "IderaDefaultServerPropertise";
        public const string DefaultServerPropertise = "DefaultServerPropertise";
        public const string AlertServerDefaultAuditSettings = "ALERT_SERVER_DEFAULT_AUDIT_SETTINGS";
        public const string ConfirmServerDefaultAuditSettings = "CONFIRM_SERVER_DEFAULT_AUDIT_SETTINGS";
        public const string AlertDatabaseDefaultAuditSettings = "ALERT_DATABASE_DEFAULT_AUDIT_SETTINGS";
        public const string ConfirmDatabaseDefaultAuditSettings = "CONFIRM_DATABASE_DEFAULT_AUDIT_SETTINGS";
        public const string RepositoryDefaultDatabaseSettings = "DefaultDatabasePropertise";
        public const string RepositoryDefaultAuditSettingDialogFlags = "DefaultAuditSettingDialogFlags";
        public const string RepositoryIderaDefaultDatabaseSettings = "IderaDefaultDatabasePropertise";
        //end sqlcm 5.6 - 5467

        public const string MAX_THREADS_KEY = "MAX_THREADS";
        public const string MAX_CONCURRENT_THREADS_KEY = "MAX_CONCURRENT_THREADS";
        public const string MAX_THREADS_VALUE = "25";
        public const string MAX_CONCURRENT_THREADS_VALUE = "25";
        public const string PARALLEL_PROCESSING_ENABLED = "PARALLEL_PROCESSING_ENABLED";

        public const string MAX_ACTIVITY_LOGS_AGE = "MAX_ACTIVITY_LOGS_AGE";
        public const string MAX_ACTIVITY_LOGS_AGE_VALUE = "60";
    }
}
