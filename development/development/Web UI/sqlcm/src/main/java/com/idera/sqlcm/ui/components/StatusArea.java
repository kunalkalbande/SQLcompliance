...
public class StatusArea extends HtmlMacroComponent {
	...
	private StatusArea.State leftState = StatusArea.State.Neutral;

	public StatusArea.State getLeftState() {
		return leftState;
	}

	public void setLeftState(StatusArea.State leftState) {
	...
	private StatusArea.State centerState = StatusArea.State.Neutral;

	public StatusArea.State getCenterState() {
		return centerState;
	}

	public void setCenterState(StatusArea.State centerState) {
	...
	private StatusArea.State rightState = StatusArea.State.Neutral;

	public StatusArea.State getRightState() {
		return rightState;
	}

	public void setRightState(StatusArea.State rightState) {
	...
	public StatusArea() {
		setMacroURI("components/sideBarStatusArea.zul");
	...
	private void updateStatusElements(StatusArea.State state,
