...
public class AlertsRuleEnableIconConverter implements Converter {
	...
	public Object coerceToUi(Object obj, Component arg1, BindContext arg2) {
		...
		return ELFunctions.getImageURL(AlertsRuleMessageOptionValues.findImageByKey(alert.isEnabled()?1:0), "small");
	}
}
