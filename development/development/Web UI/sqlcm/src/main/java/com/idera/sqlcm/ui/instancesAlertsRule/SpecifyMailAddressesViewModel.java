...
import com.idera.sqlcm.ui.dialogs.addstatusalertruleswizard.steps.SpecifyMailAddressesViewModel.Login;
...
public class SpecifyMailAddressesViewModel implements AddPrivilegedUsersViewModel.DialogListener {
 ...
 //4.1.1.5
	...
	public void initData(){
		...
		String alertMessageTitle = ELFunctions.getLabel(SQLCMI18NStrings.DEFAULT_EVENT_ALERT_RULES_TITLE);
		String alertMessageBody = ELFunctions.getLabel(SQLCMI18NStrings.DEFAULT_EVENT_ALERT_RULES_MSG);
