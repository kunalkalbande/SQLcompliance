...
public class SpecifyMailAddressesViewModel implements AddPrivilegedUsersViewModel.DialogListener {
 ...
 //4.1.1.5
	...
	public void submitChoice(@BindingParam("comp") Window x) throws Exception{
		...
		Sessions.getCurrent().setAttribute("specifyLoginList",GetTargetString());
	...
	public void initData(){
		...
		String alertMessageTitle = ELFunctions.getLabel(SQLCMI18NStrings.DEFAULT_DATA_ALERT_RULES_TITLE);
		String alertMessageBody = ELFunctions.getLabel(SQLCMI18NStrings.DEFAULT_DATA_ALERT_RULES_MSG);
