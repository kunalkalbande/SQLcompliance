...
public class FilterTextBox extends Div implements FilterElement {
    ...
    public FilterTextBox() {
        Executions.createComponents("~./sqlcm/components/filter/filter-textbox.zul", this, null);
    ...
    public class TextFilterEditEvent extends Event {
        ...
        public TextFilterEditEvent(String eventName) {
            super(eventName, FilterTextBox.this);
        }
