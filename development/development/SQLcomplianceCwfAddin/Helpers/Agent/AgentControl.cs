...
{
    /// <summary>
    /// THIS CLASS WAS COPIED FROM Idera.SQLcompliance.Application.GUI.Helper.AgentControl
    ...
    public sealed class AgentControl
    {
           ...
           )
        {
            ...
            {
                // Upgrade the SQLsecure service
                agentServiceManager.MinorUpgrade(colletionServer);
            }
            catch (System.Runtime.InteropServices.COMException COMe)
            {
                // Server is not responding
