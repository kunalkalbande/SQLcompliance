...
public abstract class FilterStepBase<WVM extends AbstractFilterWizardViewModel, WSM extends IWizardEntity>
        implements IFilterStep<WVM, WSM> {

    private WVM mParentWizardViewModel;

    private Component mRootStepComponent;

    public FilterStepBase() {
    }
