...
// Sending Trap for sysLocation of RFC1213  .1.3.6.1.2.1.1.8

  public static final String Oid = "1.3.6.1.4.1.24117";

  //IP of Local Host

  public static final String ipAddress = "192.168.0.180";
