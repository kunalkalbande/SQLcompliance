...
import com.idera.sqlcm.ui.instancesAlertsRule.SpecifyAlertMessageViewModel.Category;
import com.idera.sqlcm.ui.instancesAlertsRule.SpecifyAlertMessageViewModel.Template;
...
public class SpecifyAlertMessageViewModel implements AddPrivilegedUsersViewModel.DialogListener {
	...
	public static enum Category {
	 ...
	 public void initText(){
		    alertMessageTitle = ELFunctions.getLabel(SQLCMI18NStrings.DEFAULT_STATUS_ALERT_RULES_TITLE);
	        alertMessageBody = ELFunctions.getLabel(SQLCMI18NStrings.DEFAULT_STATUS_ALERT_RULES_MSG) ;
	 ...
	 public void initTemplateList(){
		 ...
		 /*for (Entry<String, String> entry : templateTagList.entrySet()) {
		 	...
		 	Template template = new Template("Actual Value");
			templateList.add(template);
			...
			templateList.add(template);
			template = new Template("Computer Name");
			templateList.add(template);
