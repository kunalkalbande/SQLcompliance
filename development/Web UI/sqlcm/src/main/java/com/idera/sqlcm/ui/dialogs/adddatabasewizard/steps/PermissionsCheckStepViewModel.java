...
import com.idera.sqlcm.wizard.IStep;
...
public class PermissionsCheckStepViewModel<WSE extends IWizardEntity> extends AddWizardStepBase {

    private static final String CSS_STYLE_PASSED = "color: green;";
    private static final String CSS_STYLE_FAILED = "color: red;";

    public static final String ZUL_PATH = "~./sqlcm/dialogs/adddatabasewizard/steps/permissions-check-step.zul";
