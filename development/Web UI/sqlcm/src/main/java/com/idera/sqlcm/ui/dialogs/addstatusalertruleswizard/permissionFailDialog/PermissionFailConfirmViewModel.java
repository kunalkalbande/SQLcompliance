package com.idera.sqlcm.ui.dialogs.addstatusalertruleswizard.permissionFailDialog;
...
public class PermissionFailConfirmViewModel {
    ...
    private static final String ZUL_URL = "~./sqlcm/dialogs/addstatusalertruleswizard/permission-fail-confirm-dialog.zul";
