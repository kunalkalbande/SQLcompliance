...
public abstract class AlertStepBase<WVM extends AbstractAlertWizardViewModel, WSM extends IWizardEntity>
        implements IAlertStep<WVM, WSM> {

    private WVM mParentWizardViewModel;

    private Component mRootStepComponent;

    public AlertStepBase() {
    }
