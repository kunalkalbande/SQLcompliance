...
import com.idera.sqlcm.common.grid.*;
...
public class InstanceEventsGridViewReport extends CommonGridViewReport {
    ...
    public InstanceEventsGridViewReport(String reportTitle, String reportSubTitle, String reportName) {
    ...
    public void setDataMapForListInstance(ListModelList<CMEntity> modelList) {
        ...
        for (CMEventDetails event : eventsModel) {
            ...
            if (tmpUrl != null) {
                ...
                if (addColumn) {
                    ColumnProperties col = new ColumnProperties(SQLCMI18NStrings.SERVER);
