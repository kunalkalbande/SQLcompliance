...
public class CMFilteredActivityLogsResponse {
    @JsonProperty("Alerts")
    List<CMActivityLogs> alerts;
    ...
    public CMFilteredActivityLogsResponse() {
    }

    public List<CMActivityLogs> getAlerts() {
        return alerts;
    }

    public void setAlerts(List<CMActivityLogs> alerts) {
        this.alerts = alerts;
    }
