...
import com.idera.sqlcm.enumerations.EventCategoryIcon;
import org.zkoss.bind.BindContext;
import org.zkoss.bind.Converter;
import org.zkoss.zk.ui.Component;

@SuppressWarnings("rawtypes")
public class EventIconURLConverter implements Converter {
	...
	public Object coerceToUi(Object obj, Component arg1, BindContext arg2) {
		if( obj == null || !(obj instanceof CMEventDetails) ) return "";

		CMEventDetails event = (CMEventDetails) obj;
		
		return ELFunctions.getImageURLWithoutSize((EventCategoryIcon.getByIndex(event.getCategoryId()).getIconURL()));
	}
