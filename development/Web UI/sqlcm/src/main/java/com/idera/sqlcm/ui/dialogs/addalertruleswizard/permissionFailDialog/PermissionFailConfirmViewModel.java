package com.idera.sqlcm.ui.dialogs.addalertruleswizard.permissionFailDialog;
...
public class PermissionFailConfirmViewModel {
    ...
    private static final String ZUL_URL = "~./sqlcm/dialogs/addalertruleswizard/permission-fail-confirm-dialog.zul";
