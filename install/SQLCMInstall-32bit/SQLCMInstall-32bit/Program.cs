    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            if (Environment.Is64BitOperatingSystem)
            {
                ...
                messageBox.Show("This is the 32-bit version of IDERA SQL Compliance Manager and not designed to work on this operating system. 64-bit version of software are available for download from IDERA website", "IDERA SQL Compliance Manager Installer");
                return;
            }
            ...
            {
                IderaMessageBox messageBox = new IderaMessageBox();
                messageBox.Show("Unable to create temporary installation directory", "IDERA SQL Compliance Manager Installer");
                return;
            }
            ...
            try
            {
                ...
                {
                    MemoryStream memoryStream = new MemoryStream(Resources.SQLcompliance);
                ...
                {
                    MemoryStream memoryStream = new MemoryStream(Resources.SQLcomplianceAgent);
                    memoryStream.CopyTo(fileStream);
                    memoryStream.Flush();
                    memoryStream.Dispose();
                    fileStream.Flush();
                ...
                {
                    MemoryStream memoryStream = new MemoryStream(Resources.SQLcomplianceClusterSetup);
                    memoryStream.CopyTo(fileStream);
                    memoryStream.Flush();
                    memoryStream.Dispose();
                    fileStream.Flush();
                ...
                {
                    MemoryStream memoryStream = new MemoryStream(Resources.SQLNCLI);
                    memoryStream.CopyTo(fileStream);
                    memoryStream.Flush();
                    memoryStream.Dispose();
                    fileStream.Flush();
