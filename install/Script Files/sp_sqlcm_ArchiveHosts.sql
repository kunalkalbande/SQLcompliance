USE [SQLcompliance]
GO
/****** Object:  StoredProcedure [dbo].[sp_sqlcm_ArchiveHosts]    Script Date: 2/19/2018 11:19:03 AM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
IF (OBJECT_ID('sp_sqlcm_ArchiveHosts') IS NOT NULL)
BEGIN
	DROP PROCEDURE sp_sqlcm_ArchiveHosts
END
GO

create procedure [dbo].[sp_sqlcm_ArchiveHosts] (
...
if (OBJECT_ID( '['+@archiveDbName+'].[dbo].[Hosts]' ) IS NULL )
begin
set @dbName=' Create table ['+@archiveDbName+'].[dbo].[Hosts] '
Set @sql=''
