...
namespace SQLCMInstall_64bit
{
    public static class Constants
    {
        ...
        public static string SQLCM = "SQLcompliance-x64.exe";
        public static string Agent = "SQLcomplianceAgent-x64.msi";
        public static string Cluster = "SQLcomplianceClusterSetup-x64.exe";
        ...
        public static string SQLNativeClient = "sqlncli-x64.msi";
