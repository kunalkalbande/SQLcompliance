...
namespace Installer_form_application
{
    ...
    public class VersionMismatchException : SampleProductException
    {
        ...
        public override string ErrorMessage
        {
            get
            {
                return "The SQL Compliance Manager is already installed on the same Idera Dashboard.";
            }
        }
    }
    ...
    public class InstanceExistsException : SampleProductException
    {
        ...
        public override string ErrorMessage
        {
            get
            {
                return "The display name you entered already exists.  Please enter a different display name for Idera SQL Compliance Manager installation.";
            }
        }
    }
}
